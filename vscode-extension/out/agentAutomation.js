...
exports.AGENT_AUTOMATION_SPECS = [
    {
        ...
        objective: "Decompose stakeholder requests into actionable backlog with measurable acceptance criteria and delivery risk visibility.",
        triggers: [
            { id: "issue_opened", label: "GitHub Issue opened", description: "New issue intake" },
            { id: "jira_ticket", label: "Jira ticket created", description: "New product/engineering request" },
        ...
        automatedFlow: [
            ...
            "Estimate effort and propose backlog sequence",
            "Return structured Markdown suitable for GitHub issue",
        ],
        outputs: [
            "User stories",
            "Acceptance criteria",
