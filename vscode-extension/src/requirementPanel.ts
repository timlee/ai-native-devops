...
const SECTION_MAP: { heading: string; file: string }[] = [
...
function buildPrompt(requirementsText: string): string {
  return [
...
function writeArtifacts(repoRoot: string, markdown: string): string[] {
