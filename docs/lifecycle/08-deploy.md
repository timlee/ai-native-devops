# DEPLOY Phase Guidelines

![DEPLOY Phase](../assets/images/deploy-phase.png)

## Objective

The DEPLOY phase uses AI agents and deterministic DevOps tooling to improve speed, quality, reliability, and traceability.
...
```text
You are the DEPLOY phase AI agent.
...
Task:
Analyze the current DEPLOY phase work and produce:
